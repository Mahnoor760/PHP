...
?>
    ...
    <h1>Prayer Times Calendar for 2024</h1>
<?php
    for ($month = 1; $month <= 12; $month++) {
        ...
        if ($prayerTimes) {
            ...
            echo "<tr><td colspan='6'>No data available for this month.</td></tr>";
        }
...
function displayQuranRecitation($reciter) {
    ...
    $response = file_get_contents($url);
    if (!$response) {
        echo "<p>Unable to fetch the recitation for the selected reciter.</p>";
        return;
    }
    $data = json_decode($response, true);
...
?>
    ...
    <h1>Quran Recitation by <?= $data['data']['edition']['englishName'] ?></h1>
<?php
...
<div class='footer'>
    <p>&copy; 2024 Your Company. All rights reserved By Mahnoor Tabassum
    ...
    Jazakallah. Regards Mahnoor Tabassum!</p>
</div>
